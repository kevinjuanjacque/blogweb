<?php  
    ...
    if( is_null($_FILES['imagen'])){
        ...
        $query="INSERT INTO publicaciones (usuario_id,titulo,descripcion) VALUES('$id','$titulo','$desc')";
        ...
        if (in_array($_FILES['imagen']['type'], $tipospermitidos)) {
            ...
            $query="INSERT INTO publicaciones (usuario_id ,titulo ,descripcion , url ) VALUES('$id','$titulo','$desc','$ruta')";
        }
        else{
